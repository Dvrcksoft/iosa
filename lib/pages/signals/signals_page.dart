...
import 'package:signalbyt/components/z_signal_subscribe_card.dart';
...
import 'package:signalbyt/pages/signals/signals_closed_page.dart';
...
class SignalsPage extends StatefulWidget {
  SignalsPage({Key? key, required this.type, required this.signalsAggrOpen, required this.controllerLength}) : super(key: key);
  final String type;
        ...
        title: Column(
          ...
          children: [
            Row(
              mainAxisSize: MainAxisSize.min,
              children: [
                Text('Open Signals', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, height: 1)),
              ],
            ),
          ],
        ),
              ...
              Row(
                children: [
                  ...
                  SvgPicture.asset('assets/svg/exchange.svg',
                      colorFilter: ColorFilter.mode(isLightTheme ? Colors.black54 : Colors.white, BlendMode.srcIn), height: 16, width: 16),
                ],
              ),
              Divider(height: 20),
