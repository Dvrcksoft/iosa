...
@interface RCCommonFunctionality (SWIFT_EXTENSION(PurchasesHybridCommon))
+ (void)beginRefundRequestProductId:(NSString * _Nonnull)productId completionBlock:(void (^ _Nonnull)(RCErrorContainer * _Nullable))completion SWIFT_AVAILABILITY(maccatalyst,unavailable) SWIFT_AVAILABILITY(watchos,unavailable) SWIFT_AVAILABILITY(macos,unavailable) SWIFT_AVAILABILITY(tvos,unavailable) SWIFT_AVAILABILITY(ios,introduced=15.0);
+ (void)beginRefundRequestEntitlementId:(NSString * _Nonnull)entitlementId completionBlock:(void (^ _Nonnull)(RCErrorContainer * _Nullable))completion SWIFT_AVAILABILITY(maccatalyst,unavailable) SWIFT_AVAILABILITY(watchos,unavailable) SWIFT_AVAILABILITY(macos,unavailable) SWIFT_AVAILABILITY(tvos,unavailable) SWIFT_AVAILABILITY(ios,introduced=15.0);
+ (void)beginRefundRequestForActiveEntitlementCompletion:(void (^ _Nonnull)(RCErrorContainer * _Nullable))completion SWIFT_AVAILABILITY(maccatalyst,unavailable) SWIFT_AVAILABILITY(watchos,unavailable) SWIFT_AVAILABILITY(macos,unavailable) SWIFT_AVAILABILITY(tvos,unavailable) SWIFT_AVAILABILITY(ios,introduced=15.0);
@end
